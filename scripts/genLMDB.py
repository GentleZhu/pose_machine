...
#Forked from Shih-En Wei's version
...
def writeLMDB(datasets, lmdb_path, validation):
	...
	for count in range(numSample):
		...
		elif "UE4" in data[idx]['dataset']:
			path_header = '/home/qi/pose_machine/data/'
		...
		#Add modification Qi
		scale_provided_binary = float2bytes(1.0/data[idx]['scale_provided'])
